                    ...
                    <div onclick="window.location.href='getAttractionDetails.html?id=${item.id}'" class="attraction" style="cursor: pointer;">
                        ...
                        <div class="col-two-third">
                            <div class="info">
                                ...
                                <div><input type="button" class="button margin" value="Edytuj" onclick="window.location.href='./updateAttraction.html'"></div>
                                <div><input type="button" class="button red margin" value="Usuń atrakcję" ></div>
                            </div>
                            <h3>${item.name}</h3><br>
